...
export const TopBar: React.FC = () => {
  ...
  return (
    <div className="bg-slate-50 border-b border-slate-200 text-xs text-slate-600 py-2.5 px-4 hidden md:block font-medium tracking-tight">
      <div className="max-w-[1300px] mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-6">
          <div className="flex items-center space-x-4">
            <select className="bg-transparent border-none outline-none cursor-pointer hover:text-primary font-bold text-[11px] uppercase tracking-wide text-slate-500">
              <option>English</option>
              <option>Español</option>
              <option>Français</option>
            </select>
            <select 
              className="bg-transparent border-none outline-none cursor-pointer hover:text-primary font-bold text-[11px] uppercase tracking-wide text-slate-500"
              value={currency}
          ...
          <div className="flex items-center space-x-3">
            <button 
              ...
              className="hover:text-primary uppercase font-bold text-[10px] tracking-widest text-slate-500"
            >
              Login
            </button>
            <button 
              onClick={goToCustomerAuth}
              className="bg-primary hover:bg-blue-600 text-white px-4 py-1.5 rounded-[3px] font-bold text-[10px] transition uppercase tracking-widest shadow-sm hover:shadow-md"
            >
              Signup
            </button>
          </div>
