-- Create Admin Order Notification Email Template
-- This template is specifically for admin notifications with custom subject
  ...
  <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
    ...
    <div style="padding: 30px;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="https://your-admin-dashboard.com/orders/{{order_id}}" style="display: inline-block; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: #ffffff; text-decoration: none; padding: 14px 32px; border-radius: 8px; font-weight: 600; font-size: 16px;">View Order Details</a>
      </div>
    </div>
